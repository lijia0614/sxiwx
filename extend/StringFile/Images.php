...
class Images {
    ...
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=48, $height=22, $verifyName='verify') {
        $randval = Strings::randStrings($length, $mode);
		...
		$fontface = WEB_PATH . "/public/fonts/simhei.ttf";
	   ...
	   $borderColor = imagecolorallocate($im, 255, 255, 255);   
        ...
        for ($i = 0; $i < $length; $i++) {
            ...
            $codex = Strings::msubstr($randval, $i, 1);
            imagettftext($im, 22, 15, $pos*$i+30, 30, $fontcolor, $fontface, $codex);
        }
    ...
    static function GBVerify($length=4, $type='png', $width=180, $height=50, $fontface='simhei.ttf', $verifyName='verify') {
        $code = Strings::randStrings($length, 4);
        ...
        for ($i = 0; $i < $length; $i++) {
            ...
            imagettftext($im, 16, 15, 25 * $i+10, 25, $fontcolor, $fontface, $codex);
        }
        Images::output($im, $type);
    }
