...
img.onload=function(){$.Jcrop(from,options)};img.src=loadsrc}if(typeof(options)!=="object"){options={}}this.each(function(){if($(this).data("Jcrop")){if(options=="api"){return $(this).data("Jcrop")}else{$(this).data("Jcrop").setOptions(options)}}else{attachWhenDone(this)}});return this}})(jQuery);
    ...
    $.fn.zyUpload = function(options, param) {
        ...
        return this.each(function() {
            ...
            this.createHtml = function() {
				...
				para.upname ? upname = upname: upname = "image";
                var html = "";
                if (para.dragDrop) {
                    ...
                    html += '						<input id="fileImage" type="file" size="30" name="'+para.upname+'[]" ' + multiple + ">";
                    html += "					</div>";
                    html += "				</div>";
                    ...
                    html += '							<img class="upload_image" src="/public/vend/zyupload/images/add_img.png" style="width:expression(this.width > ' + imgWidth + " ? " + imgWidth + 'px : this.width)" />';
                    html += "						</div>";
                    html += "					</a>";
                    html += "				</div>";
                    html += "			</div>";
            ...
            this.funDisposePreviewHtml = function(file, e) {
                ...
                var newStr = file.name.split("").reverse().join("");
                var type = newStr.split(".")[0].split("").reverse().join("");
                var fileImgSrc = "/public/vend/zyupload/images/fileType/";
                if (type == "rar") {
