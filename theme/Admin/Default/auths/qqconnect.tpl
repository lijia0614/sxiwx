     ...
     <fieldset> 
      ...
      <table width="100%" class="table_form"> 
       <tbody> 
        ...
        <tr> 
         <td width="12%">App Key</td> 
         <td><input type="text" id="AppKey" style="width:300px;"  datatype="*" nullmsg="请输入App Key" class="input-text" value="{:isset($data['AppKey'])&&$data['AppKey']?$data['AppKey']:''}" name="AppKey" placeholder="AppKey" /> <span id="messageBox" for="title" generated="true" class="onShow Validform_checktip">请输入App Key</span></td> 
        </tr>                       
