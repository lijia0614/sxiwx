     ...
     <fieldset> 
      ...
      <table width="100%" class="table_form"> 
       <tbody> 
        ...
        <tr> 
         <td width="12%">APP ID</td> 
         <td><input type="text" id="appid"  style="width:300px;" class="input-text"   datatype="*" nullmsg="请输入APP ID"  value="{:isset($data['appid'])&&$data['appid']?$data['appid']:''}" name="appid" placeholder="请输入APP ID" /> <span id="messageBox" for="title" generated="true" class="onShow Validform_checktip">请输入APP ID</span> </td> 
        </tr>    
        
        <tr> 
         <td width="12%">App Secret</td> 
         <td><input type="text" id="image" style="width:300px;"    datatype="*" nullmsg="请输入App Secret" class="input-text" value="{:isset($data['AppSecret'])&&$data['AppSecret']?$data['AppSecret']:''}" name="AppSecret" placeholder="App Secret" />  <span id="messageBox" for="title" generated="true" class="onShow Validform_checktip">请输入App Secret</span> </td> 
        </tr>                       
        ...
        <tr> 
         <td>TOKEN</td> 
         <td> 
         <input type="text" id="TOKEN" style="width:300px;" datatype="*" nullmsg="请输入TOKEN" class="input-text" value="{:isset($data['TOKEN'])&&$data['TOKEN']?$data['TOKEN']:''}" name="TOKEN" placeholder="TOKEN Secret" />  <span id="messageBox" for="title" generated="true" class="onShow Validform_checktip">请输入TOKEN</span> 
         </td> 
        </tr>      
