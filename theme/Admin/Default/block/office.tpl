<if condition="$v.fields_type eq 'office'">
		<tr>
			<td>{$v.title}：</td>
			<td>
				<div class="upload_button">
					...
					<a class="file" href="javascript:;">选择文件<input type="file" name="up_{$v.fields}[]" id="up_{$v.fields}" module-name="{:CONTROLLER}"  fields-name="{$v.fields}" class="img_file upOffice" upkey="{$v.fields}" /></a>
