...
<div class="pad-10">
    ...
    <div class="common-form">
        <if condition="isset($id)">
            <form action="{:url(SYS_PATH."/book/addRecommend")}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
                ...
                <tr>
                    ...
                    <td>
                        <select name="id">
                            ...
                            <zhimeng table="book" where="[['is_recommend','=',0],['is_del','=',0]]" >
