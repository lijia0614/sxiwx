     ...
     <fieldset> 
      ...
      <table width="100%" class="table_form"> 
       <tbody> 
        ...
        <tr> 
         <td width="12%">分类名称</td> 
         <td><input type="text" id="name"  style="width:300px;" class="input-text topinyin" datatype="*" value="{:isset($data['name'])&&$data['name']?$data['name']:''}" name="name" placeholder="请输入分类名称" /><span id="messageBox" for="name" generated="true" class="Validform_checktip onShow ">分类名称</span> </td>
        </tr>
