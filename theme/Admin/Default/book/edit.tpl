    ...
    <script language="javascript">
        ...
        KindEditor.ready(function(K) {
            editor = K.create('.editor', {
                items: ["source", "undo", "redo", "preview", "cut","copy", "paste", "plainpaste", "wordpaste", "justifyleft", "justifycenter", "justifyright", "justifyfull", "indent", "quickformat", "selectall", "|", "fullscreen", "formatblock", "fontname", "fontsize","forecolor", "strikethrough", "lineheight","removeformat",  "hr"],
                resizeType: 1,
...
<div class="pad-10">
    ...
    <div class="common-form">
        <if condition="isset($id)">
            <form action="{:url(SYS_PATH."/book/edit",array('id'=>$id))}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
                <input type="hidden" name="id" value="{$id}" />
                <else />
                <form action="{:url(SYS_PATH."/book/add")}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
        </if>
        ...
        <fieldset>
            <table width="100%" class="table_form">
                ...
                <tr>
                    <td>内容简介</td>
                    <td>
                        <textarea style="width:550px; height:300px;" class="editor"  name="info" id="info">{:isset($data['info'])&&$data['info']?$data['info']:''}</textarea> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="onoff">
                            <label for="is_okami1" id="cs" class="cb-enable <if condition="$data['is_okami'] eq 1">selected</if>">是</label>
