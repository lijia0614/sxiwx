    ...
    <div class="common-form">
        ...
        <fieldset>
            <table width="100%" class="table_form">
                ...
                <input type="hidden" name="type" id="type" value="okami_sort"/>
                <tr>
                    <td width="16%">书籍名称</td>
                ...
                <tr id="price_num">
                    <td width="12%">大神推荐排序</td>
                    <td><input type="number" id="sort"  style="width:150px;" class="input-text"  value="{$data['okami_sort']}" name="sort"  /> <span id="messageBox" for="name" generated="true" class="Validform_checktip onShow ">数字越小排序越靠前</span> </td>
                </tr>
