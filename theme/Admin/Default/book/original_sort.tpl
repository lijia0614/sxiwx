    ...
    <div class="common-form">
        ...
        <fieldset>
            <table width="100%" class="table_form">
                ...
                <input type="hidden" name="type" id="type" value="original_sort"/>
                <tr>
                    <td width="16%">书籍名称</td>
                ...
                <tr id="price_num">
                    <td width="12%">原创新品排序</td>
                    <td><input type="number" id="sort"  style="width:150px;" class="input-text"  value="{$data['original_sort']}" name="sort"  /> <span id="messageBox" for="name" generated="true" class="Validform_checktip onShow ">数字越小排序越靠前</span> </td>
                </tr>
