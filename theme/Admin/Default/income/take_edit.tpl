...
<div class="pad-10">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3>订阅管理</h3>
                <h5 style="color: indianred">注意：只能编辑订阅价格，请谨慎操作</h5>
            </div>
        </div>
    </div>
    <div class="common-form">
        <if condition="isset($id)">
            <form action="{:url(SYS_PATH."/income/takeEdit",array('id'=>$id))}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
        ...
        <fieldset>
            <table width="100%" class="table_form">
                ...
                <if condition="$data['chapter']">
                    <tr>
                        <td width="16%">章节名称</td>
                        <td>
                            <input readonly style="width:200px;" class="input-text" value="{$data['chapter']}"/> <span id="messageBox" for="name" generated="true" class="Validform_checktip onShow ">章节名称不可编辑</span> </td>
                    </tr>
                    <else/>
                    <tr>
                        <td width="16%">购买类型</td>
                        <td>
                            <input readonly style="width:200px;" class="input-text" value="整书购买"/> <span id="messageBox" for="name" generated="true" class="Validform_checktip onShow ">此内容不可编辑</span> </td>
                    </tr>
                </if>

                <tr>
                    <td width="12%">书籍作者</td>
                    <td><input type="text"  style="width:150px;" class="input-text" value="{$data['author']}" /> <span id="messageBox" for="name" generated="true" class="Validform_checktip onShow ">书籍作者不可编辑</span> </td>
                </tr>

                <tr>
                    <td width="12%">订阅价格</td>
                    <td>
                        <input type="text" id="price"  style="width:200px;" class="input-text" datatype="*"  value="{$data['price']}"  name="price"  />
