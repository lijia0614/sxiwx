...
<div class="pad-10">
    ...
    <div class="common-form">
        <if condition="isset($id)">
            <form action="{:url(SYS_PATH."/member/toLetter")}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
                <else />
                <form action="{:url(SYS_PATH."/member/toLetter")}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
        </if>
        ...
        <fieldset>
            <table width="100%" class="table_form">
                ...
                <tr>
                    <td width="16%">私信用户</td>
                    <td>
                        <input  style="width:350px;" readonly class="input-text" value="{$name}"/>
                    </td>
                </tr>
                ...
                <tr>
                    <td>私信内容：</td>
                    <td>
                        <textarea style="width:370px; height:400px;" class="editor"  datatype="*"  name="content" id="content"></textarea>
                    </td>
                </tr>
