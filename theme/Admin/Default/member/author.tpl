<div class="nav"><span>作者列表</span></div>
...
<form method="get" action="{:url(SYS_PATH.'/'.CONTROLLER.'/author')}" class="ajaxSearchFrom">
	<div class="query">
		<div class="query-conditions ue-clear">
			...
			<div class="query-btn ue-clear">
				<a style="margin-top: 5px; margin-left: 20px;" href="javascript:;" class="confirm searchButton"
				   data-url="{:url(SYS_PATH."/".CONTROLLER."/author")}">查询</a>
			</div>
		</div>
	</div>
</form>
	...
	<table width="100%" class="ltable">
        ...
        <volist name="list" id="vo">
			<tr>
				...
				<td>
					<if condition="$vo.author_time">
                        {$vo.author_time|date='Y-m-d H:i'}
						<else/>
						<span style="color: pink">无</span>
					</if>
