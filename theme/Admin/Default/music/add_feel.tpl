...
<body>
  ...
  <div class="pad-10"> 
   ...
   <if condition="isset($id)">
    <form action="{:url(SYS_PATH."/".CONTROLLER."/addFeel")}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
     ...
     <fieldset> 
      ...
      <table width="100%" class="table_form"> 
       <tbody> 
        ...
        <tr> 
         <td width="12%">情感类型</td>
         <td><input type="text" id="title"  style="width:300px;" class="input-text topinyin" datatype="*" value="" name="title" placeholder="请输入情感类型" /><span id="messageBox" for="name" generated="true" class="Validform_checktip onShow ">情感类型</span> </td>
        </tr>
