...
<body>
  ...
  <div class="pad-10"> 
   ...
   <if condition="isset($id)">
    <form action="{:url(SYS_PATH."/".CONTROLLER."/addLang")}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
     ...
     <fieldset> 
      ...
      <table width="100%" class="table_form"> 
       <tbody> 
        ...
        <tr> 
         <td width="12%">语言名称</td>
         <td><input type="text" id="title"  style="width:300px;" class="input-text topinyin" datatype="*" value="" name="title" placeholder="请输入语言名称" /><span id="messageBox" for="name" generated="true" class="Validform_checktip onShow ">语言名称</span> </td>
        </tr>
