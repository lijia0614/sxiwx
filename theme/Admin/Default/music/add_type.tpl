...
<body>
  ...
  <div class="pad-10"> 
   ...
   <if condition="isset($id)">
    <form action="{:url(SYS_PATH."/".CONTROLLER."/addType")}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
     ...
     <fieldset> 
      ...
      <table width="100%" class="table_form"> 
       <tbody> 
        ...
        <tr> 
         <td width="12%">风格名称</td>
         <td><input type="text" id="title"  style="width:300px;" class="input-text topinyin" datatype="*" value="" name="title" placeholder="请输入风格名称" /><span id="messageBox" for="name" generated="true" class="Validform_checktip onShow ">语言名称</span> </td>
        </tr>


        <tr> 
         <td width="12%">排序</td> 
         <td><input type="text" id="sort" class="input-text" style="width:80px;" value="" name="sort" placeholder="排序" /> <span id="messageBox" for="title" generated="true" class="onShow ">数字越小，排名越前</span> </td>
        </tr>          
