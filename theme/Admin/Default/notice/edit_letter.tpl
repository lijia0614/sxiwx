...
<div class="pad-10">
    ...
    <div class="common-form">
        <if condition="isset($id)">
            <form action="{:url(SYS_PATH."/notice/editLetter")}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
        ...
        <fieldset>
            <table width="100%" class="table_form">
                ...
                <tr>
                    <td width="16%">真实姓名</td>
                    <td>
                        <input readonly style="width:200px;" class="input-text" value="{$data['name']}"/>
                    </td>
                </tr>
                ...
                <tr>
                    <td width="16%">昵称</td>
                    <td>
                        <input readonly style="width:200px;" class="input-text" value="{$data['pen_name']}"/>
                    </td>
                </tr>
                ...
                <tr>
                    <td>私信详情：</td>
                    <td>
                        <textarea style="width:370px; height:400px;" class="editor"  datatype="*"  name="content" id="content">{$data['content']}</textarea></td>
                </tr>
