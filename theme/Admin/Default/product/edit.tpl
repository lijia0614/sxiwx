...
<div class="pad-10">
    ...
    <div class="common-form">
        <if condition="isset($id)">
            <form action="{:url(SYS_PATH."/product/edit",array('id'=>$id))}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
                <input type="hidden" name="id" value="{$id}" />
                <else />
                <form action="{:url(SYS_PATH."/product/add")}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
        </if>
