...
<div class="pad-10">
    ...
    <div class="common-form">
        <form action="{:url(SYS_PATH."/welfare/addKeep",array('id'=>$id))}" method="post" class="formvalidate" id="DataFromSubmit" isajax="true">
        <fieldset>
            <table width="100%" class="table_form">
                ...
                <tr>
                    <td width="12%">奖励金额</td>
                    <td><input type="text" id="info"  style="width:300px;" class="input-text" datatype="*" nullmsg="请输入模式类型" value="{$data['info']}" name="info" placeholder="请输入模式类型" /> <span id="messageBox" for="title" generated="true" class="Validform_checktip onShow ">请输入模式类型</span> </td>
                </tr>
