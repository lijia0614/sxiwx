    ...
    <div class="user-manage-wrap">
        <section class="main-wrap">
            <nav class="component-nav-wrap">
                <div class="info text-center"><img src="//s.weituibao.com/static/vh1za.png" class="avatar">
            ...
            <div class="mobile-center">
                <h3 class="m-title text-center"><span class="fl" style="position: absolute; z-index: 1;"></span>
                    <div>个人中心</div>
                </h3>
                <div class="user-info">
                ...
                <a class="line-item" href="/usermanage/wallet?init_tab=0">
                    <img src="images/6bje4.png">
                    <span>消费记录</span><i></i>
                </a>
                <a class="line-item" href="/usermanage/wallet?init_tab=1">
