                                ...
                                <div class="ant-tabs-nav-scroll">
                                    <div class="ant-tabs-nav ant-tabs-nav-animated">
                                        ...
                                        <div role="tab" aria-disabled="false" aria-selected="true"
                                            ...
                                            <a href="{:url('info/xiaofei')}">消费记录</a>
                                        </div>
                                        <div role="tab" aria-disabled="false" aria-selected="false"
                                             class=" ant-tabs-tab">
                                            <a style="color: #778090" href="{:url('info/wallet')}">充值记录</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="ant-table-content">
                                        <div class="ant-table-body">
                                            <table class="">
                                                ...
                                                <tr>
                                                    <th class=""><span>消费金额</span></th>
                                                    <th class=""><span>类别</span></th>
                                                    <th class=""><span>消费明细</span></th>
                                                    <th class=""><span>消费时间</span></th>
                                                </tr>
                                                </thead>
                                                    ...
                                                    <div class="library-list">
                                                        <tr>
                                                            <if condition="$vo.gift_name">
                                                                ...
                                                                <td style="">{$vo.gift_name} * {$vo.number}</td>
                                                                <td style="">
