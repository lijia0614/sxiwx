...
<div id="app">
    <div class="wrap">
        <div class="m-nav ">
            ...
            <input id="keywords" type="search" placeholder="输入书名/关键词" value="{$keywords}">
        </div>
                        ...
                        <div class="search-result">
                            <div class="novel-list">
                                ...
                                <div class="novel-item clearfix">
                                    <a class="img-link" arget="_blank" href="{:url('read/index',['id'=>$vo['id']])}">
                                    ...
                                    <a target="_blank" href="{:url('read/index',['id'=>$vo['id']])}">
                                        <p class="desc">{$vo.info}</p>
                                    </a>
                                    <div class="author">
                                        <span class="category">{$vo.c_name}</span>
                                        <span class="status"><if condition="$vo['is_end'] eq 0">连载中<else/>完结</if></span>
                                    </div>
                                </div>
                                </volist>
                            </div>
