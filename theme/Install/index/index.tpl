...
.agreenBox{ width:680px; color:#555; margin:10px 50px 10px; line-height:25px; border:1px solid #ddd; padding:10px; height:400px; overflow-y:scroll; border:px solid #efefef; float:left; border-radius:5px; }
...
.ament h1{ font-size:24px; margin:15px 0px 15px 0px; }
	...
	<div class="head">
		...
		<div class="rhelp"><a href="javascript:void(0);" target="_blank"><i>？</i>安装帮助</a></div>
			...
			<div class="agreenBox ament">
                <h1 align="center">ZmCMS 用户授权协议</h1>
                版权所有 (c) 2016-2018，四川挚梦科技有限公司保留所有权利。 <br>
				ZmCMS的官方网址是： <a href="http://www.zhi-meng.cn/" target="_blank">www.zhi-meng.cn</a>  <br />
				为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：<br />
				<strong>一、ZmCMS官方对本授权协议拥有最终解释权。</strong><br />
				<strong>二、协议许可的权利</strong> <br />
				1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于商业用途。 <br />
				2、您可以在协议规定的约束和限制范围内修改 ZmCMS源代码或界面风格以适应您的网站要求。 <br />
				3、您拥有使用本软件构建的网站全部内容所有权，并独立承担与这些内容的相关法律义务。<br />		  
                4、获得商业授权之后，您可以将本软件应用于商业用途，同时依据所购买的授权类型中确定的技术支持内容，自购买时刻起，在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。商业授权用户享有反映和提出意见的权力，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。 <br />	
				<strong>三、协议规定的约束和限制</strong> <br />		    
				1、未获商业授权之前，不得将本软件用于任何用途。购买商业授权请登录 www.zhi-meng.cn 了解最新说明。<br />	
				2、未经官方许可，不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。<br />	
				3、不管你的网站是否整体使用ZmCMS ，还是部份栏目使用ZmCMS，在你使用了ZmCMS的网站主页上必须加上ZmCMS官方网址(www.zhi-meng.cn)的链接。<br />	
				4、未经官方许可，禁止在ZmCMS的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。<br />	
                ...
                3、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装ZmCMS，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。<br />	
				4、如果本软件带有其它软件的整合API示范例子包，这些文件版权不属于本软件官方，并且这些文件是没经过授权发布的，请参考相关软件的使用许可合法的使用。<br />	
				协议发布时间： 2018年01月01日	<br />
				</p>
			
			</div>
        
		<div class="next" style="padding:0 0 20px 0;">
			<a href="{:url("Install/index/index",array('step'=>2))}"  class="submit">同意并开始安装</a>
		</div>        
