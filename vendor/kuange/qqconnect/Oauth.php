...
class Oauth{
    ...
    public function get_userinfo(){
        ...
        $url="https://graph.qq.com/user/get_user_info?access_token=".$this->recorder->read("access_token")."&oauth_consumer_key=".$this->recorder->readInc("appid")."&openid=".$this->recorder->read("openid");
		$response = $this->urlUtils->get_contents($url);
        //--------检测错误是否发生
        if(strpos($response, "callback") !== false){
            $lpos = strpos($response, "(");
            $rpos = strrpos($response, ")");
